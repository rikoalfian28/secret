...
async def list_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for uid, data in users.items():
        text += f"ID: {uid}, Verified: {data.get('verified')}, Admin: {data.get('is_admin', False)}\n"
    await update.message.reply_text(text or "Tidak ada user.")
